...
class DAGDataSet:
    def __init__(self, num_timeslots=1, num_partitions=[50,16,20,10], apply_partition=True, net_manager=None, svc_arrival=None):
    ...
    def data_gen(self, net_manager=None, svc_arrival=None):
        ...
        self.service_info = [self.service_info[0]]
        ...
        for dnn in self.service_info:
            ...
            if self.apply_partition:
                ...
                for layer_info in dnn['layers']:
                    svc.partitions.append(Partition(service=svc, **deepcopy(layer_info)))
    ...
    def graph_coarsening(self, num_partitions):
        ...
        for svc in self.svc_set.services:
            ...
            cg, T_tran, T_proc = p_algo.run_algo(svc=svc, num_partitions=num_partitions[svc.id])
