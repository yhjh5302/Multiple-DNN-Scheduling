...
class A3CAgent:
    def __init__(self, env, gamma, lr, global_max_episode):
        ...
        self.global_network = Network(self.obs_dim, self.num_containers, self.num_servers)
        ...
        self.worker = Worker(0, env, self.gamma, self.global_network, self.global_optimizer, self.global_episode, self.GLOBAL_MAX_EPISODE)
