...
from wrappers.platfrom_wrappers import ScaledStateWrapper, PlatformFlattenedActionWrapper, ScaledParameterisedActionWrapper
import gym_platform
...
for global_step in range(1, args.total_timesteps + 1):
    ...
    if len(rb.buffer) > args.batch_size and global_step % 100 == 0:
        ...
        writer.add_histogram("actions/run", action[1][0], global_step)
        writer.add_histogram("actions/hop", action[1][1], global_step)
        writer.add_histogram("actions/leap", action[1][2], global_step)
